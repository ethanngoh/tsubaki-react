...
function createBaseAccountMetadata(): AccountMetadata {
  return { netZero: false, provider: "", virtual: false };
}
...
export const AccountMetadata = {
  encode(
    ...
    if (message.netZero === true) {
      writer.uint32(8).bool(message.netZero);
    }
    if (message.provider !== "") {
  ...
  fromJSON(object: any): AccountMetadata {
    return {
      netZero: isSet(object.netZero) ? Boolean(object.netZero) : false,
  ...
  toJSON(message: AccountMetadata): unknown {
    const obj: any = {};
    message.netZero !== undefined && (obj.netZero = message.netZero);
  ...
  fromPartial<I extends Exact<DeepPartial<AccountMetadata>, I>>(
    ...
    const message = createBaseAccountMetadata();
    message.netZero = object.netZero ?? false;
...
export const Account = {
  ...
  fromJSON(object: any): Account {
    return {
      ...
      createdAtMs: isSet(object.createdAtMs) ? Number(object.createdAtMs) : 0,
